			...
			<div className="z-10 text-left max-w-5xl w-full">
				...
				>
					...
					<div className="flex items-center gap-6">
						...
						<a href="mailto:aryanarkhitbehra@gmail.com" className="text-latte-overlay2 dark:text-rosepine-subtle hover:text-latte-blue dark:hover:text-rosepine-foam transition-colors"><Mail size={24} /></a>
					</div>
				</motion.div>
			</div>
